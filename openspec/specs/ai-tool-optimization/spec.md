...
Owner-scoped AI analysis of draft MCP tools and OpenAPI import candidates that proposes bounded metadata and request-shaping improvements under explicit authorization, typed policy validation, and atomic draft-only application.
