...
Live model discovery, compatibility qualification, selected-model persistence, and Mastra-backed runtime resolution for account-scoped AI provider connections.
