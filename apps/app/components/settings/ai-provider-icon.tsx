import { AI_PROVIDER_KINDS, type AiProviderKind } from "@repo/core";
...
> = {
  [AI_PROVIDER_KINDS.OPENAI]: OpenAiIcon,
  [AI_PROVIDER_KINDS.ANTHROPIC]: AnthropicIcon,
  [AI_PROVIDER_KINDS.XAI]: XaiIcon,
  [AI_PROVIDER_KINDS.META]: MetaIcon,
  [AI_PROVIDER_KINDS.OPENROUTER]: OpenRouterIcon,
  [AI_PROVIDER_KINDS.OPENCODE_ZEN]: OpenCodeIcon,
  [AI_PROVIDER_KINDS.OPENCODE_GO]: OpenCodeIcon,
};
...
export function AiProviderIcon({
  ...
  className,
  ...props
}: { providerKind: AiProviderKind } & IconProps) {
  const Icon = PROVIDER_ICONS[providerKind];
