...
import { capturePostHogEvent, resetPostHogIdentity } from "@/lib/posthog";
...
/** Drops cached tRPC queries for the signed-in user (e.g. me, observability). */
export function clearUserTrpcQueries(queryClient: QueryClient) {
  queryClient.removeQueries(api.user.pathFilter());
}
